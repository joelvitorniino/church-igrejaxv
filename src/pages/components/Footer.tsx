...
export default function Footer() {
  return (
    <footer className="p-4 bg-white rounded-lg shadow md:px-6 md:py-8 dark:bg-gray-900 lg:-mr-0 iphone:-mr-24">
      <div className="sm:flex sm:items-center sm:justify-between">
        ...
        <ul className="flex flex-wrap items-center mb-6 text-sm text-gray-500 sm:mb-0 dark:text-gray-400">
          ...
          <li>
            <Link href="/donation" className="mr-4 hover:underline md:mr-6">
              Doação
            </Link>
          </li>
          <li>
            <Link href="/request_prayer" className="hover:underline">
              Oração
            </Link>
          </li>
        </ul>
